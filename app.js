...
var multiplyThree = multiply(multArr[0],multArr[1])[0];
var multiplyFour = multiply(multiplyThree,multArr[2]);
var messageFour = 'The numbers ' + multArr + ' have a product of ' + multiplyFour[0] + '.';
console.log('multiplyFour',multiplyFour);
console.log('messageFour',messageFour);
return[multiplyFour[0],messageFour];
}
